...
from train_cifar10_vae import define_VAE
...
def visualise_latent_space(decoder, n_grid=10):
    ...
    Z = Z.reshape(n_grid, n_grid, 32, 32)
...
def get_models():
    ...
    encoder.load_weights('cifar10_enc_weights_latent_dim_2.h5')
    decoder.load_weights('cifar10_dec_weights_latent_dim_2.h5')
    K.set_learning_phase(True)
    model = keras.models.load_model('save/cifar10_cnn_da_run.h5')
