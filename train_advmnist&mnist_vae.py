...
if __name__ == '__main__':
    ...
    encoder.save_weights('advmnist&mnist_enc_weights_latent_dim_' + str(latent_dim) + '.h5')
    decoder.save_weights('advmnist&mnist_dec_weights_latent_dim_' + str(latent_dim) + '.h5')
